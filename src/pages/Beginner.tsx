...
export default function Beginner() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="mx-auto max-w-[1700px] px-8 py-10 xl:px-12">

        {/* HERO */}

        <div className="mb-10 grid gap-8 lg:grid-cols-3">

          <div className="rounded-3xl border border-slate-200 bg-white p-10 shadow-lg lg:col-span-2">
        ...
        <div className="mt-14 rounded-3xl border border-slate-200 bg-white p-10 shadow-lg">
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            {completedCount === totalLessons ? (
              ...
              <Link
                to="/intermediate"
                className="rounded-2xl bg-green-600 px-8 py-4 font-semibold text-white transition-all duration-300 hover:bg-green-700"
              >
        ...
        <div className="mt-12 flex flex-col gap-4 md:flex-row md:justify-between">
          ...
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white px-6 py-4 font-semibold text-slate-700 transition-all hover:border-green-600 hover:text-green-700"
          >
            ← 🏠 হোমে ফিরে যান
          </Link>
          ...
          <Link
            to="/intermediate"
            className="inline-flex items-center justify-center rounded-2xl bg-green-600 px-6 py-4 font-semibold text-white transition-all hover:bg-green-700"
          >
